...
import { discussionsApi, type DiscussionItem } from '@/entities/discussion/api/discussions.api';
...
export default function DiscussionsPage() {
  ...
  const { data: discussions, isFetching } = useQuery({
    ...
    queryFn: () => discussionsApi.list({ regionId, districtId }).then((r) => r.data.data),
